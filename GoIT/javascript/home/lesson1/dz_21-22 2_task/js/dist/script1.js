...
$(function () {
    ...
    function answerCalculator() {
        $("input[name='forCounter']").each(function () {
            if ($(this).hasClass("isCorrect1") && this.checked) {
                //  $(this).is(":checked")
                correctOption++;
    ...
    var $overlayWindow = void 0; /* затеняющий блок */
    var $windowResult = void 0; /* блок результаты теста*/
    var $resultClose = void 0; /* кнопка закрыть  блоки */
    var $resultHead = void 0; /* заголок  блока */
    var $allAnswer = void 0; /* блок результаты теста*/
    var $answerCorrect = void 0; /* правильные ответы*/
    var $answerWrong = void 0; /* неправильные ответы*/
    var $answerConference = void 0; /* совет по результату*/
