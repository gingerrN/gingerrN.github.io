...
var mySkills = _.map(myJson, "skills");
/*console.log(mySkills);*/

var myReduce =_.reduce(mySkills, function(flattened, other) {
  return flattened.concat(other);
}, []);
/*console.log(myReduce);*/
var myUnion = _.union(myReduce);
/*console.log(myUnion);*/

var mySort = myUnion.sort();
console.log('1. Массив скиллов по алфавиту mySort', mySort);



/*2. Массив имен (поле name) людей, отсортированных в зависимости от количества их друзей (friends); */
var myFriend=  _.sortBy(myJson, 'friends.length');
/*console.log('myFriend', myFriend);*/

var myName = _.map(myFriend, 'name');
/*var myName = _.map(myFriend, function(o){
  var myObj = {};
  myObj.name = o.name;
  myObj.friends = o.friends.length;
  return myObj;
});*/
console.log('2. Имена людей в зависимости от количества их друзей myName', myName);


/*3. Массив всех друзей всех пользователей, не должно быть повторяющихся людей*/
var myPeople = _.map(myJson, "friends");
/*console.log('myPeople', myPeople);*/

var myReducePeople =_.reduce(myPeople, function(flattened, other) {
  return flattened.concat(other);
}, []);
/*console.log('myReducePeople', myReducePeople);*/

var myPeopleName = _.map(myJson, "name");
/*console.log('myPeopleName', myPeopleName);*/

var myUnionName = _.union(myPeopleName);
console.log('3. Друзья всех пользователей myUnionName', myUnionName);
